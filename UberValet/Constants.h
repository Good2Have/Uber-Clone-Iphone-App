...
//#define API_URL    @"http://www.appdupe.info/uber_alpha/ws/"

 #define API_URL   @"http://uber.globusapps.com/ws/"

         //Development
//#define API_URL    @"http://uber.globusapps.com/"
//#define API_URL    @""//Live
...
extern NSString *const FILE_CLIENT_CAR_Detail;//client_car_details.php
