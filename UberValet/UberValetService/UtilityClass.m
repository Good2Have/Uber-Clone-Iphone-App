...
-(NSString *)getAge:(NSDate *)birthDate{
     ...
     */
//    return [NSString stringWithFormat:@"%li",(long)components.year];
    return nil ; 
}

-(NSDate *)timestempToDate:(NSString *)timestemp
{
    NSDate *date = [NSDate dateWithTimeIntervalSince1970:[timestemp doubleValue]];
    return date;
}
