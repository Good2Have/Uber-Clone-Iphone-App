...
-(void)setUserInfo:(NSMutableDictionary *)newUserInfo
{
    ...
    [dic setObject:[newUserInfo valueForKey:@"name"] forKey:@"name"];
    [dic setObject:[newUserInfo valueForKey:@"email"] forKey:@"email"];
    [dic setObject:[newUserInfo valueForKey:@"contact"] forKey:@"contact"];
    [dic setObject:[newUserInfo valueForKey:@"reg_time"] forKey:@"reg_time"];
    [dic setObject:[newUserInfo valueForKey:@"client_id"] forKey:@"client_id"];
    [dic setObject:[newUserInfo valueForKey:@"country_code"] forKey:@"country_code"];

    [USERDEFAULT setObject:dic forKey:UD_USER_INFO];
